            ...
            <div class="container">
                <div class="row intro-tables" style="color: #000">
                    <div class="col-md-4"  v-for="book in books" :key="book.name">
                        ...
                        <div  style="float: right;margin-left: 5px"><router-link :to="{ name: 'characters', params: { book_id: getID(book.url), book_name: book.name } }"  class="comment-btn" data-toggle="tooltip" data-placement="bottom" title="Characters">Characters <i class="info-icon icon_star_alt"></i></router-link></div>
